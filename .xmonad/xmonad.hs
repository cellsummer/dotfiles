...
import XMonad.Actions.CycleWS (nextWS, prevWS, Direction1D(..), moveTo, shiftTo, WSType(..), nextScreen, prevScreen)
...
myKeys =
    ...
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        ...
        , ("M-p j", spawn "dm-emoji")         -- emoji selector
        ...
        , ("M-p w", spawn "weather-xmobar")   -- refresh weather in xmobar
    ...
    -- KB_GROUP Windows navigation
        ...
        , ("M-m", windows W.swapMaster) -- Swap the focused window and the master window
