...
maps.n["n"] = { "nzz", desc = "Center the search result results" }
maps.n["N"] = { "Nzz", desc = "Center the search result results" }
maps.n["*"] = { "*zz", desc = "Center the search result results" }
...
maps.n["<leader>Ai"] = { "<cmd>ChatGPTActAs<cr>", desc = "ChatGPT" }
maps.n["<leader>vb"] = { "<cmd>!open -a 'Brave Browser' '%'<cr>", desc = "View in Brave Browser" }
...
-- Manage Buffers
maps.n["x"] = { function() require("astronvim.utils.buffer").close() end, desc = "Close buffer" }
...
if is_available "neo-tree.nvim" then
  ...
  maps.n["<leader>f"] = { "<cmd>Neotree reveal_force_cwd<cr>", desc = "Reveal in Explorer" }
  maps.n["<leader>o"] = {
    function()
...
if is_available "vim-table-mode" then
  maps.n["<leader>tm"] = { "<cmd>TableModeToggle<CR>", desc = "Toggle table mode" }
  maps.n["<leader>tr"] = { "<cmd>TableModeRealign<CR>", desc = "Table mode realign" }
end

if is_available "vim-dadbod-ui" then maps.n["<leader>DB"] = { "<cmd>DBUIToggle<CR>", desc = "Toggle DB UI" } end
...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>sr"] = { function() require("telescope.builtin").oldfiles() end, desc = "Find history" }
  maps.n["<leader>so"] = { "<cmd>Telescope frecency<CR>", desc = "Find history" }
  maps.n["<leader>sR"] = { function() require("telescope.builtin").registers() end, desc = "Find registers" }
  maps.n["<leader>st"] =
    { function() require("telescope.builtin").colorscheme { enable_preview = true } end, desc = "Find themes" }
  maps.n["<leader>sw"] = { function() require("telescope.builtin").live_grep() end, desc = "Find words" }
  maps.n["<leader>ss"] = { function() require("telescope.builtin").spell_suggest() end, desc = "Spell suggest" }
  maps.n["<leader>sW"] = {
    function()
...
if is_available "toggleterm.nvim" then
  ...
  maps.t["<F7>"] = maps.n["<F7>"]
  maps.n["<C-BSlash>"] = maps.n["<F7>"]
  maps.t["<C-BSlash>"] = maps.n["<F7>"]
end
